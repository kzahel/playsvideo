...
- **Cross-device resume and handoff (implemented)** — Activity is complete
  across devices with device filters, shared recovery actions, equivalent
  media identity resolution, and durable torrent download resume intent. See the
